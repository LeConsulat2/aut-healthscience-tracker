...
export default function Counselling() {
  return (
    <main className="min-h-screen min-w-sm min-h-sm max-w-sm max-h-sm flex flex-col items-center justify-center bg-gradient-to-br from-rose-50 via-white to-amber-100 px-4">
      <div className="bg-white shadow-lg border border-gray-200 rounded-2xl max-w-md w-full p-8 sm:p-10 text-center">
        ...
        <h1 className="text-2xl font-semibold text-gray-800 mb-2">Counselling Programme</h1>
